 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&g(t.buffer)},isString:y,isNumber:b,isBoolean:t=>!0===t||!1===t,isObject:E,isPlainObject:w,isUndefined:d,isDate:A,isFile:O,isBlob:R,isRegExp:L,isFunction:m,isStream:t=>E(t)&&m(t.pipe),isURLSearchParams:v,isTypedArray:I,isFileList:B,forEach:S,merge:/**
...
config:k.toJSONObject(this.config),code:this.code,status:this.response&&this.response.status?this.response.status:null}}});const $=M.prototype,z={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED","ERR_NOT_SUPPORT","ERR_INVALID_URL"].forEach(t=>{z[t]={value:t}}),Object.defineProperties(M,z),Object.defineProperty($,"isAxiosError",{value:!0}),// eslint-disable-next-line func-names
...
)o.push(function(t,e,r){for(var n,o=[],i=e;i<r;i+=3)o.push(q[(n=(t[i]<<16&16711680)+(t[i+1]<<8&65280)+(255&t[i+2]))>>18&63]+q[n>>12&63]+q[n>>6&63]+q[63&n]);return o.join("")}(t,i,i+16383>s?s:i+16383));return 1===n?o.push(q[(e=t[r-1])>>2]+q[e<<4&63]+"=="):2===n&&o.push(q[(e=(t[r-2]<<8)+t[r-1])>>10]+q[e>>4&63]+q[e<<2&63]+"="),o.join("")};for(var q=[],H=[],J="undefined"!=typeof Uint8Array?Uint8Array:Array,V="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",W=0,G=V.length;W<G;++W)q[W]=V[W],H[V.charCodeAt(W)]=W;// Support decoding URL-safe base64 strings, as Node.js does.
...
t=tx(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}const tP=k.toFlatObject(k,{},null,function(t){return/^is[A-Z]/.test(t)});var tj=/**
...
r=tx(r),a.forEach(function(t,n){k.isUndefined(t)||null===t||e.append(!0===s?tL([r],n,i):null===s?r:r+"[]",f(t))}),!1)}}return!!tN(t)||(e.append(tL(o,r,i),f(t)),!1)}let c=[],h=Object.assign(tP,{defaultVisitor:l,convertValue:f,isVisitable:tN});if(!k.isObject(t))throw TypeError("data must be an object");return!function t(r,n){if(!k.isUndefined(r)){if(-1!==c.indexOf(r))throw Error("Circular reference detected in "+n.join("."));c.push(r),k.forEach(r,function(r,i){let s=!(k.isUndefined(r)||null===r)&&o.call(e,r,k.isString(i)?i.trim():i,n,h);!0===s&&t(r,n?n.concat(i):[i])}),c.pop()}}(t),e};/**
 ...
 */function tk(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function tM(t,e,r){let n;/*eslint no-param-reassign:0*/if(!e)return t;let o=r&&r.encode||tk,i=r&&r.serialize;if(n=i?i(e,r):k.isURLSearchParams(e)?e.toString():new tF(e,r).toString(o)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+n}return t}tD.append=function(t,e){this._pairs.push([t,e])},tD.toString=function(t){let e=t?function(e){return t.call(this,e,t_)}:t_;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var t$=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){k.forEach(this.handlers,function(e){null!==e&&t(e)})}},tz={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},tq="undefined"!=typeof URLSearchParams?URLSearchParams:tF,tH="undefined"!=typeof FormData?FormData:null,tJ="undefined"!=typeof Blob?Blob:null;/**
...
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var tG={classes:{URLSearchParams:tq,FormData:tH,Blob:tJ},isStandardBrowserEnv:tV,isStandardBrowserWebWorkerEnv:tW,protocols:["http","https","file","blob","url","data"]},tK=/**
...
u.ontimeout=function(){let e=t.timeout?"timeout of "+t.timeout+"ms exceeded":"timeout exceeded",n=t.transitional||tz;t.timeoutErrorMessage&&(e=t.timeoutErrorMessage),r(new M(e,n.clarifyTimeoutError?M.ETIMEDOUT:M.ECONNABORTED,t,u)),// Clean up request
 ...
 *
 * @returns {object}
 */function(t,e,r){if("object"!=typeof t)throw new M("options must be an object",M.ERR_BAD_OPTION_VALUE);let n=Object.keys(t),o=n.length;for(;o-- >0;){let i=n[o],s=e[i];if(s){let e=t[i],r=void 0===e||s(e,i,t);if(!0!==r)throw new M("option "+i+" must be "+r,M.ERR_BAD_OPTION_VALUE);continue}if(!0!==r)throw new M("Unknown option "+i,M.ERR_BAD_OPTION)}},validators:eh};const eg=ed.validators;/**
 ...
 */class ey{constructor(t){this.defaults=t,this.interceptors={request:new t$,response:new t$}}/**
   ...
   */request(t,e){let r,n;"string"==typeof t?(e=e||{}).url=t:e=t||{},e=el(this.defaults,e);let{transitional:o,paramsSerializer:i,headers:s}=e;void 0!==o&&ed.assertOptions(o,{silentJSONParsing:eg.transitional(eg.boolean),forcedJSONParsing:eg.transitional(eg.boolean),clarifyTimeoutError:eg.transitional(eg.boolean)},!1),null!=i&&(k.isFunction(i)?e.paramsSerializer={serialize:i}:ed.assertOptions(i,{encode:eg.function,serialize:eg.function},!0)),// Set config.method
...
const{Axios:ew,AxiosError:eA,CanceledError:eO,isCancel:eR,CancelToken:eB,VERSION:ev,all:eS,Cancel:eT,isAxiosError:eU,spread:eC,toFormData:eI,AxiosHeaders:eN,HttpStatusCode:ex,formToJSON:eL,getAdapter:eP,mergeConfig:ej}=eE,e_=document.getElementById("success");document.getElementById("tg-form").addEventListener("submit",function(t){t.preventDefault();let e=this.name.value,r=this.tel.value,n=this.comment.value;eE.post("/send-message",{name:e,tel:r,comment:n}).then(t=>{console.log("Статус ответа:",t.status),console.log("Данные ответа:",t.data),this.name.value="",this.tel.value="",this.comment.value="",e_.innerHTML="Сообщение отправлено!",e_.style.display="block"}).catch(t=>{console.warn(t)}).finally(()=>{console.log("Отправили!")})});//# sourceMappingURL=index.d4cd1c4b.js.map

//# sourceMappingURL=index.d4cd1c4b.js.map
